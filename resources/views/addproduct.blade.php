                ...
                <div class="p-6 bg-white border-b border-gray-200"> 
                    <form method="POST" action="{{ route('insertdata') }}" enctype="multipart/form-data">
                        ...
                        <div class="pt-5 pb-3">
                            ...
                            <input value ="{{ Auth::user()->username}}" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded-md py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" name="username" id="username" readonly>
                        </div>
                        {{-- code product --}}
                        <div class="pb-3">
                            <label for="code_product" class="block text-gray-700 text-sm font-bold mb-2">Code Product</label>
                            <input value="{{ $randomString }}" class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded-md py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" name="code_product" id="code_product" placeholder="code_product" readonly>
                        </div>
                        {{-- name --}}
                        <div class="pb-3">
                            <label for="name" class="block text-gray-700 text-sm font-bold mb-2">Work Name</label>
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded-md py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" name="name" id="name" placeholder="Name">
                        </div>
                        {{-- Number of Revision --}}
                        <div class="pb-3">
                            <label for="numberRevision" class="block text-gray-700 text-sm font-bold mb-2">Number of Revision</label>
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded-md py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" name="numberRevision" id="numberRevision" placeholder="Number of Revision">
                        </div>
                        {{-- price --}}
                        <div class="pb-3">
                        ...
                        <div class="pb-3">
                            ...
                            <input class="appearance-none block w-full h-100 bg-gray-200 text-gray-700 border rounded-md py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" name="description" id="description">
                        </div>
                        {{-- category --}}
                        <div class="pb-3">
