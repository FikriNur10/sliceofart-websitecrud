...
<div class="bg-white">
    <div class="container mx-auto">
      <div class="relative py-10">
        ...
        >
          <h1
            class="text-4xl sm:text-5xl lg:text-6xl font-semibold text-gray-800 sm:w-12/12 pt-10"
          >
            All About Art
          </h1>
          <p
            class="text-base leading-normal text-gray-800 mt-4 sm:mt-5 sm:w-7/12"
          >
